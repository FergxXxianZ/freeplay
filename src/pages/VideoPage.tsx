...
export const VideoPage: React.FC = () => {
  ...
  const isSecureUrl = video.video_url.startsWith('https://interstitial.slicedrive.com/') || video.video_url.startsWith('https://cdn2.slicedrive.com/') || video.video_url.startsWith('https://media.slicedrive.com/') || video.video_url.startsWith('https://cdn.videy.co/') || video.video_url.startsWith('https://cdn2.videy.co/') || video.video_url.startsWith('https://videy.co/');
